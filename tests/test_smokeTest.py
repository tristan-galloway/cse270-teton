...
class TestSmokeTest():
  ...
  def test_test3DirectoryGridandListfeature(self):
    ...
    WebDriverWait(self.driver, 30).until(expected_conditions.text_to_be_present_in_element((By.ID, "directory-grid"), "GRID"))
  ...
  def test_test4JoinPageDataEntry(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("Tristan")
    self.driver.find_element(By.NAME, "fname").send_keys(Keys.ENTER)
    self.driver.find_element(By.NAME, "lname").click()
    self.driver.find_element(By.NAME, "lname").send_keys("Galloway")
    self.driver.find_element(By.NAME, "lname").send_keys(Keys.ENTER)
    self.driver.find_element(By.NAME, "bizname").send_keys("Teton Surfing")
  ...
  def test_test5AdminPageUsernamePassword(self):
    ...
    self.driver.find_element(By.ID, "username").send_keys("JoeBiden")
    self.driver.find_element(By.ID, "password").send_keys("not2024")
